...
// Name of the cookie we use to remember that the user passed the gate
const ACCESS_COOKIE = "site_access";

// Optional: customize which paths are unprotected (e.g. API, static assets, auth pages)
const PUBLIC_PATHS = [
  "/auth/signin",
  "/auth/signup",
  "/_next",
...
export function middleware(request: NextRequest) {
  ...
  const passwordAttempt = nextUrl.searchParams.get("site_password");
